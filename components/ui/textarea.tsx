...
/**
 * Phase 2 / Step 2.3 — Textarea primitive.
 *
 * Vertically resizable control with typography synchronised to Input
 * (`text-sm`), 1px border, neutral focus ring, and explicit disabled/invalid
 * states. Supports the same label/hint/error wiring as Input.
 */
  ...
  return (
    <div className="flex w-full flex-col gap-1.5">
      ...
      <textarea
        ...
        className={cn(
          'flex min-h-24 w-full resize-y rounded-lg border border-input bg-surface px-3 py-2 text-sm text-foreground shadow-sm transition-colors duration-150',
